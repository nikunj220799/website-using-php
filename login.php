...
.login-image{
    background: url("https://tallypress.com/wp-content/uploads/2018/05/top-10-online-gift-shops-in-singapore.jpg");
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Welcome To Birthday Bash!</h1>
